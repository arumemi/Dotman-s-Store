...
const footer = () => {
  return (
    <footer className='bg-gray-700 text-white py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-7xl mx-auto'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8'>
          {/* Company Info */}
          <div>
            <h3 className='text-xl font-bold mb-4'>Click & Call</h3>
            <p className='text-gray-400 text-sm'>Your trusted technology store. Quality products at the best prices.</p>
          </div>
          ...
          <div>
            ...
            <ul className='space-y-2'>
              ...
              <li><Link to='/contact' className='text-gray-400 hover:text-white transition-colors duration-200 text-sm'>Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className='space-y-2 text-sm'>
              <li className='text-gray-400'>Email: rolfadinternational@gmail.com</li>
              <li className='text-gray-400'>Tel: (+234) 816 942 9947</li>
              <li className='text-gray-400'>WhatsApp: (+234) 816 942 9947</li>
            </ul>
          </div>
        </div>
