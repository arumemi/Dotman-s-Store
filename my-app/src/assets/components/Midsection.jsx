...
/*display midsection products in a reponsive grid layout
...
const Midsection = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto px-4 sm:px-4 lg:px-8 py-12'>
        {/* Section heading */}
        <h2 className='text-3xl md:text-4xl font-bold mb-12 text-gray-800 text-center'>Our laptop collection</h2>
    ...
    <div className='space-y-2 /flex-grow'>
              ...
              <button
                ...
                className='mt-auto bg-red-600 text-white py-2 px-4  rounded-lg hover:bg-red-700
