...
const Hero = () => {
  return (
    <div className='relative min-h-screen w-full bg-cover bg-center bg-no-repeat' style={{backgroundImage: `url(${bgImage})`}}>
      ...
      {/* Content */}
      <div className='relative z-20 flex flex-col items-center justify-center text-white min-h-screen px-4 sm:px-6 lg:px-8 py-12 text-center'>
        ...
        <button className='bg-red-600 hover:bg-red-700 active:bg-red-800 text-white font-bold px-6 py-3 sm:px-8 sm:py-4 rounded-lg shadow-xl hover:shadow-2xl transform hover:scale-105 active:scale-95 transition-all duration-300 uppercase tracking-wider text-sm sm:text-base'>
          Coleção da Loja
        </button>
      </div>
    </div>
